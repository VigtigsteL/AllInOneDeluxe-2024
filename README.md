...
## 🔷当前版本：V1.7.3 | 更新日期：2024.03.21

*感谢原作者 @GrandSong 对此次更新的肯定。*
<br>*已获得二次开发作者 @Yuanze31 许可。*
<br>*如果有任何需要完善的地方、希望更改或添加的功能。*
<br>*欢迎大家反馈与讨论。*

***
### 关于 **本模组 更新概况** 请查看➡️[[本模组Steam页面](https://steamcommunity.com/sharedfiles/filedetails/?id=3151283978)]<br>关于 **本模组 更新详情** 请查看<[改动说明](https://steamcommunity.com/sharedfiles/filedetails/changelog/3151283978)>

### 关于 模组 详细说明 请查看<[原始模组](https://steamcommunity.com/sharedfiles/filedetails/?id=821415114)>与<[二次开发模组](https://steamcommunity.com/sharedfiles/filedetails/?id=2895128242)>页面
***
...
<br>*(红色-囚犯专用，橙色-狱中劳役，黄色-囚犯活动，蓝色-员工专用，青色-交通运输，绿色-农业)*

3. **修复和重绘"贴图"，解决了“餐盘、农作物、监控警告"等图标错误 和 “白色栅栏门”无法对齐等错误**

4. 修复：原模组的”报告-接收囚犯”界面中，“囚犯到达时间”、“移除囚犯接收限制”、“囚犯替换” 的按钮无法显示
...
<br>*· 例如"牢房"现在按以下标准评分：*
<br>*· (面积 / 窗户 / 床铺 / 桌子 / 座位 / 卫生 / 环境 / 舒适 / 娱乐 / 锻炼 / 文化宗教 / 安全 / 隐私)*
...
<br>*稍微减少了方案费用、时间长度、参加次数，部分课程稍微增加了参与席位 (如：行为疗法)*
...
1. [V1.6.0] 重大更新：
<BR>对"物品价格"、"物品分类"、"物品筛选"、"物品文本"进行了优化或重制。
<BR>（依据物品特点重新设计价格，并解决某些物品”缺少分类“和”分类不准确“的问题，<BR>现在使用"物品筛选"加"按名称排序"会获得更好的使用体验。[详情请查阅改动说明]）

3. 更改：优化所有"材料"的堆叠数量

4. 修复：所有可售出货物价格低于预期

5. 更改："宠物鸟"范围扩大，满足需求的能力随距离递减

6. 修复："矮书架"无法被上架书籍

7. 更改："医药箱"内放置了戒断药物，能够使周围的囚犯少量满足酒精与毒品需求

8. 增加："风扇"可满足舒适需求，可回收垃圾桶、盆栽可满足环境需求

9. 更改 ："灯"、"枕头"允许克隆

10. 更改："金属探测器"位置调整回物品菜单

11. 修复："车牌"与"空车牌"的出售错误(感谢 @军刃血梦 提交的反馈)

12. 更改：调整模组功能"囚犯分拣器"的生效范围，以与监控范围相符

13. [V1.2.0]
<br>- 更改：自动收集器 现在能够在果园中放置
<br>- 更改：可回收垃圾桶 需要完成研究“回收激励”才可使用

14. [V1.2.1] 修复："农作物喷洒装置"未研究“农业”时可放置的错误，并且现在只能在相关区域放置

15. [V1.3.0]
<br>- 更改：提高"禁闭门"与"安全禁闭门"的韧性
<br>- 添加："监控摄像头"能够少量满足囚犯的安全需求，但同时会增加隐私需求

16. [V1.5.0]
<br>- 添加："咖啡机"能够满足员工"饮水"与"疲劳"需求
<br>- 添加："各类植物"能够影响环境或自然需求
  
### 七、其他
***重新设计内容与绘制贴图***

**1. [V1.3.2] 重制：重新设计"行政研究"的所有内容，并更换了背景图片**
**2. [V1.3.4] 优化：所有"统计图表"中的介绍、提示、格式，并更换了背景图片**
**3. [V1.5.0] 重制：重新编写和设计了所有需求数据，详情见<改动说明>**
