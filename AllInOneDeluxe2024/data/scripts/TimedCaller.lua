...
function menu()
	...
	local miz = {
		{'when', 'Caption', this.when_h, 'H', this.when_m, 'M'},
		{'h_p', 'Button'},
		{'h_m', 'Button'},
		{'m_p', 'Button'},
		{'m_m', 'Button'},
...
function call(change_guard)
	if change_guard or this.last_call_from == nil then
		g = look(this, {'Guard'}, isOk, 10, true) or look(this, {'Guard'}, isOk, 15, true) or look(this, {'Guard'}, isOk, 20, true) or look(this, {'Guard'}, isOk, 25, true) or look(this, {'Guard'}, isOk, 30, true)
		if g then
			musterG(g)
