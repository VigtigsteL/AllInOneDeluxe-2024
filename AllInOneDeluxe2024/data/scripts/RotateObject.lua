...
local objTypes = {'PersonalSink', 'MedicineCabinet',  'AccountingTable', "Bed", "BunkBed", "Crib", "PlayMat", "Toilet", "Table", "Chair", "Bench", "JailDoor", "JailDoorLarge", "JailDoorXL","Door", "StaffDoor", "SolitaryDoor", "RemoteDoor", "JailBars", "Window", "WindowLarge", "Cooker", "Fridge", "Bin", "Sink", "ServingTable", "ShowerHead", "Bookshelf", "OfficeDesk", "SchoolDesk", "FilingCabinet", "MedicalBed", "MorgueSlab", "PowerSwitch", "WaterBoiler", "MetalDetector", "WeightsBench", "PhoneBooth", "Tv", "LargeTv", "PoolTable", "Cctv", "CctvMonitor", "DoorControlSystem", "PhoneMonitor", "Servo", "DoorTimer", "LogicCircuit", "IroningBoard", "VisitorTable", "VisitorTableSecure", "DogCrate", "GuardLocker", "SofaChairSingle", "SofaChairDouble", "DrinkMachine", "ArcadeCabinet", "Radio", "Altar", "Pews", "PrayerMat", "LibraryBookshelf", "SortingTable", "ShopFront", "ShopShelf", "GuardTower", "WeaponRack", "Radiator"}
