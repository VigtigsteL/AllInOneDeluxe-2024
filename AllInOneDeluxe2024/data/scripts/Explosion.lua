...
function Explode()
	...
	--normal entities
	local entityTypes = { "Prisoner", 'Avatar', "Warden", "Chief", "Guard", "DogHandler", "Dog", "Cook", "Janitor", "Gardener", "Doctor", "Psychologist", "Accountant", "Lawyer", "Teacher", "Visitor", "SpiritualLeader", "AppealsMagistrate", "AppealsLawyer", "ExecutionWitness", "Paramedic", "ParoleOfficer", "ParoleLawyer", "TruckDriver", 'BoldHost', 'CameraMan' }
	...
	blowObjGroup(0.5, 0.7, { "Light",  "ShowerHead", "Bleach", "Window", "FoodWaste", "Meal", "PrisonerUniform", "DirtyPrisonerUniform", "CrumpledPrisonerUniform", 'Cctv', 'PowerSwitch', 'LibraryBookUnsorted', 'LibraryBookSorted', 'MailUnsorted', 'MailSorted', 'PrisonerMail', 'PrisonerMailOpened', 'ShopGoods', })

	blowObjGroup(1, 1, { "Box", "Stack", "Door", "StaffDoor", "WindowLarge", "Cooker", "Fridge", "Bin", "SheetMetal", "LicensePlateBlank", "LicensePlate", "Ingredients", "IngredientsCooking", "IngredientsCooked", "IngredientsSpoiled", "FoodTray", "FoodTrayDirty", "GrassTurf", "Log", "Wood", "SchoolDesk", "SofaChairSingle","Radio", "Tv", "PrayerMat", 'Radiator', 'LaundryBasket', 'DogCrate',  'PhoneBooth', 'Capacitor', 'PipeValve', 'Sprinkler', "Chair", 'MailSatchel', 'FoodBowl', })

	blowObjGroup(1, 6, { "Drain"})
	blowObjGroup(1.5, 2, { "Bed", "Toilet", 'PersonalSink', "Table", "Bench", "Bookshelf", "OfficeDesk", "FilingCabinet", 'IroningBoard', 'LargeTv', "DrinkMachine", 'ArcadeCabinet',  })
	blowObjGroup(2, 2, { "BunkBed", "SuperiorBed", "MedicalBed", "SofaChairDouble", "Sink", "ServingTable", 'VisitorTable', 'WeightsBench', 'WeaponRack', 'WaterBoiler', 'PoolTable', 'Servo', 'DoorTimer', })
	blowObjGroup(2, 6, { 'PressurePad'})

	blowObjGroup(2.5, 3, { "JailDoor", "JailBars", "Brick", "Concrete", "Steel", "MorgueSlab", "Altar", "Pews", "LibraryBookshelf", 'SortingTable', 'ShopFront', 'GuardLocker', 'PhoneMonitor', 'LaundryMachine', })
	blowObjGroup(3, 4, { "ElectricChair", "JailDoorLarge", "JailDoorXL","SolitaryDoor", "RemoteDoor", 'WorkshopSaw', 'WorkshopPress', 'CarpenterTable', 'VisitorTableSecure', 'CctvMonitor', 'DoorControlSystem', })
	blowObjGroup(3, 5, { "RoadGate"})

	-- Won't move
	blowObjGroup(1.5, -1, { "Tree", "TreeStump", 'ShopShelf', 'PowerStation', 'WaterPumpStation', })
	blowObjGroup(3, -1, {"SupplyTruck", "PrisonerBus", "FireEngine", "RiotVan", "Ambulance", "Hearse", "Limo", "TroopTruck", })
...
local WallMaterials = {ConcreteWall=true, BrickWall=true, BurntWall=true, Fence=true, PerimeterWall=true}
